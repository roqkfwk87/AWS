...
// Consumer는 return된 Promise를 받은 후에 then, catch, finally로 값을 가공하는 역할을 함 
// promise
// Promise의 then을 호출하게 되면 똑같은 Promise를 return하기 때문에 catch는 그 return된 Promise에 대해서 catch를 호출하게 되는 것 
// then, catch는 위에서 retuen된 값 
