...
//		System.out.println(hm.goal); // 내가 보는 시야가 다시 좁아졌기 때문에 실행을 할 수 없음 (fp가 가지고 있는 기능보다 좁은 범위인 hm에 넣음) 
...
// int intVariable = 128(0111 1111);들어있는 바이트 타입이다.
// 원래 데이터에다가 0000 0000 0111 1111 추가가됨 
// 요기 있는 녀석에다가 바이트 타입을 추가하면 앞에 0000 0000 이 소실되서 0111 1111이 됨 

// 참조변수는 시야가 바뀐다고 했지만 숄트상태 데이터타입이 바뀐다.(소실되고 추가되고 함) 이런 차이가 있음 
