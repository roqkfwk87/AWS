...
public class B_Package2 {
	...
	public static void main(String[] args) {
		...
		// 범위 제약 
		System.out.println(random.nextInt(45)); // 16 // 0 ~ 44의 숫자가 랜덤으로 나옴 // 0 ~ 지정수 -1까지 랜덤으로 나옴 (인덱스 번호) 
		System.out.println(random.nextInt() % 45); // -17 // -45 ~ 44 // % 숫자를 하면 음수값이 나옴  
