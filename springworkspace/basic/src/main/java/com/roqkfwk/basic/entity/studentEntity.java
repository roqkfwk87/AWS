...
@Entity(name="student")
//@Table :
// - 해당 Entity 클래스를 RDBNS의 어떤 테이블과 매핑할지 지정하는 어노테이션 
// - name 속성 : 매핑할 RDBNS의 테이블 명을 지정 
// - 만약, 클래스명 - Enitity명 - Table명이 동일하면 생략 가능 
@Table(name="student")
public class studentEntity {
    ...
    // - lenght 속성 : 컬럼의 길이 (데이터베이스 기준 varchar(이 안에 들어가는 숫자를 컬럼의 길이라고 함))
