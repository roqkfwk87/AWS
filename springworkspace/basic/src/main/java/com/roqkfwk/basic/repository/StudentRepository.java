...
// @Repositiory : 해당 클래스를 Spring Bean으로 등록하는 어노테이션, @Component와 동일
...
// - JPA 기반 Repositiory를 생성할떄 반드시 상속해야함 
// - 매개타입 T : 해당 Repository가 어떤 Entity의 Repository인지 나타내는 매개타입
// - 매개타입 ID : 해당 Repository가 어떤 Entity의 Primary key 데이터 타입을 지정하는 매개타입
