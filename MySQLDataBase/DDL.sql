...
ADD added_column INT; # added_column 추가 

-- 테이블 컬럼 삭제
ALTER TABLE example_table
DROP COLUMN added_column; # added_column 삭제 

-- 테이블 컬럼 타입 수정 
ALTER TABLE example_table
MODIFY COLUMN string_column VARCHAR(200); # 100 -> 200으로 변경 

-- 테이블 컬럼 이름 수정 
ALTER TABLE example_table
CHANGE string_column varchar_column VARCHAR(200); # string_column -> varchar_column으로 변경 
